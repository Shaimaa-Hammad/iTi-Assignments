...
function getCookie(cookieName) {
    if(!cookieName){
        throw new Error ("Please provide name for the cookie!");
    }
    else if(typeof(cookieName) != "string"){
        throw new Error ("Please provide string name for the cookie!");
    }
    else {
...
function hasCookie(cookieName) {
  ...
  console.log(setCookie('4', "rrr"));
  console.log(getCookie(4));